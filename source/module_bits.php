...
if ( ! defined( 'NETCURL_BITMASK_RELEASE' ) ) {
	define( 'NETCURL_BITMASK_RELEASE', '6.0.1' );
}
if ( ! defined( 'NETCURL_BITMASK_MODIFIY' ) ) {
	define( 'NETCURL_BITMASK_MODIFIY', '20180320' );
}

// Check if there is a packagist release already loaded, since this network standalone release is deprecated as of 20180320.
if ( ! class_exists( 'MODULE_BITMASK' ) && ! class_exists( 'TorneLIB\MODULE_BITMASK' ) ) {
	/**
